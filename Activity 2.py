...
input("List: " + str(scores)+ "  n = 9 Linear search - checks lest to rigth.  Press Enter")
...
mid = len(scores) //2
print("  Best:  1 check -> O(1)   Average:", mid, "checks -> 0(n) Worst: 9 checks -> O(n)  Yours:", steps)

input("All three cases.  Press Enter")
print("  Best O(1)  Average O(n)  Worst O(n)   ->  Big-0 = worst case = 0(n) ")